...
class IssueDetailModal extends StatelessWidget {
        ...
        return Container(
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Row(children: [
                Icon(issue.severityIcon, color: issue.severityColor, size: 24),
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  // Badges row
                  Row(children: [
                    _badge('Severity', issue.severityLabel, issue.severityColor),
                  ...
                  if (issue.lineNumber != null) ...[
                    ...
                    _codeBlock(issue.codeExample ?? 'Line ${issue.lineNumber}: [code at this line]', const Color(0xFFFF4757)),
                    const SizedBox(height: 20),
                  ],
                  ...
                  const SizedBox(height: 8),
                  Text(issue.description, style: TextStyle(fontSize: 14, height: 1.6, color: isDark ? AppColors.darkTextSecondary : AppColors.lightTextSecondary)),
                  const SizedBox(height: 20),
                  ...
                  if (issue.explanation != null) ...[
                    ...
                    const SizedBox(height: 8),
                    Text(issue.explanation!, style: TextStyle(fontSize: 14, height: 1.6, color: isDark ? AppColors.darkTextSecondary : AppColors.lightTextSecondary)),
                    const SizedBox(height: 20),
                  ],
                  ...
                  if (issue.suggestion != null)
                    Text(issue.suggestion!, style: TextStyle(fontSize: 14, height: 1.5, color: isDark ? AppColors.darkTextSecondary : AppColors.lightTextSecondary)),
                  ...
                  Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('💡 Pro Tip', style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.primary)),
                      const SizedBox(height: 6),
                      Text(issue.simpleExplanation, style: const TextStyle(fontSize: 13, height: 1.5)),
                    ]),
                  ),
                  const SizedBox(height: 20),
                  ...
                  Row(children: [
                    Expanded(
                      child: _actionButton(context, '📋 Copy Fix', () {
                        Clipboard.setData(ClipboardData(text: issue.exampleFix ?? issue.suggestion ?? ''));
  ...
  Widget _codeBlock(String code, Color accentColor) {
    return Container(
      ...
      child: Text(code, style: GoogleFonts.firaCode(fontSize: 12, color: AppColors.darkText, height: 1.6)),
    );
  }
  ...
  Widget _actionButton(BuildContext context, String label, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(child: Text(label, style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w700))),
      ),
    );
  }
}
