              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (current.codeSnippet != null)
                      _buildCodeSnippet(current.codeSnippet!),
                    if (current.codeSnippet != null) const SizedBox(height: 16),
                    ..._buildOptions(isDark),
                    if (_isAnswered) ...[
                      const SizedBox(height: 16),
                      _buildFeedback(isDark),
                    ],
                  ],
                ),
              ),
        ...
        children: [
          ...
          Expanded(
            child: LinearPercentIndicator(
              lineHeight: 10,
              percent: (_currentQuestion + 1) / questions.length,
              ...
              linearGradient: LinearGradient(
                colors: [
                  widget.lesson.color,
                  widget.lesson.color.withValues(alpha: 0.7),
                ],
              ),
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: widget.lesson.color.withValues(alpha: 0.2),
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                _isCorrect ? Icons.celebration_rounded : Icons.info_rounded,
                color: _isCorrect ? AppColors.accentGreen : AppColors.error,
                size: 22,
              ),
              const SizedBox(width: 8),
