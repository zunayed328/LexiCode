      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Text(
              '${provider.user.lessonsCompleted} done',
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Center(
                child: Text(
                  provider.user.proficiencyLevel,
                  style: GoogleFonts.inter(
                    fontSize: 16,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    'Current Level: ${provider.user.proficiencyLevel}',
                    style: GoogleFonts.inter(
                      fontSize: 15,
                      fontWeight: FontWeight.w600,
                    ),
  ...
  Widget _buildUnit(BuildContext context, LessonUnitModel unit, bool isDark) {
    return Column(
      ...
      children: [
        ...
        // Lessons in unit
        ...unit.lessons.map(
          (lesson) => _buildLessonTile(context, lesson, isDark),
        ),
          ...
          children: [
              ...
              decoration: BoxDecoration(
                gradient: lesson.isCompleted
                    ? LinearGradient(
                        colors: [
                          lesson.color,
                          lesson.color.withValues(alpha: 0.7),
                        ],
                      )
                    : null,
                color: lesson.isCompleted
                    ? null
                    : lesson.color.withValues(alpha: 0.15),
                borderRadius: BorderRadius.circular(13),
              ),
              child: Icon(
                lesson.isLocked
            ...
            Column(
              children: [
                ...
                const Text(
                  'XP',
                  style: TextStyle(fontSize: 10, color: AppColors.xpColor),
                ),
              ],
            ),
          ],
