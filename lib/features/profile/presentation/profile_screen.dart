...
class _ProfileScreenState extends State<ProfileScreen>
    ...
    return Scaffold(
      body: SafeArea(
        child: CustomScrollView(
          ...
          slivers: [
            SliverToBoxAdapter(child: _buildProfileHeader(user, provider, isDark)),
            ...
            SliverToBoxAdapter(child: _buildSettingsSection(provider, isDark, context)),
    ...
    return Padding(
      ...
      child: Column(children: [
              ...
              child: CustomPaint(
                painter: _ProgressRingPainter(
                  ...
                  gradient: const LinearGradient(
                    colors: [_cyanAccent, AppColors.primary, _emeraldAccent],
                  ),
                ),
              ),
            ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          GestureDetector(
            onTap: () => _showEditNameSheet(context, provider, user.name, isDark),
            child: Container(
              width: 28,
              height: 28,
              decoration: BoxDecoration(
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            const Icon(Icons.military_tech_rounded, color: AppColors.primary, size: 16),
    ...
    return Padding(
      ...
      child: GlassCard(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            const Icon(Icons.insights_rounded, color: _cyanAccent, size: 20),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          ...
          child: TabBar(
            ...
            labelColor: _tabController.index == 0 ? _cyanAccent : _emeraldAccent,
  ...
  // ─── Settings Section ────────────────────────────────────────────
  Widget _buildSettingsSection(AppProvider provider, bool isDark, BuildContext context) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(20, 8, 20, 8),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('Settings', style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 10),
        GlassCard(
          ...
          child: Column(children: [
            ...
            _buildSettingsTile(
              ...
              'Notifications',
              AppColors.secondary,
              trailing: Switch.adaptive(value: true, onChanged: (_) {}, activeColor: AppColors.primary),
            ),
            Divider(height: 1, color: isDark ? AppColors.darkBorder : AppColors.lightBorder),
            _buildSettingsTile(
                        ...
                        onPressed: () async {
                          ...
                          try {
                            if (context.mounted) {
                              ...
                              context.read<LearningProvider>().clearUserData();
                            ...
                            if (context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Failed to log out: $e', style: const TextStyle(color: Colors.white)),
          ...
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.lock_outline_rounded, color: _cyanAccent, size: 20),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.lock_reset_rounded, color: _cyanAccent, size: 20),
                suffixIcon: IconButton(
                  icon: Icon(
  ...
  Widget _buildAboutSection(bool isDark) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(20, 8, 20, 0),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('About', style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 10),
        GlassCard(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
